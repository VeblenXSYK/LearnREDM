...
int Layer::save_to_buffer(void **outbuffer)
{
	static const int PNG_COLOR_TYPE_RGB_ALPHA = 6;
	...
	return LodePNG_encode_buffer(outbuffer, reinterpret_cast<unsigned char *>(image_data_), width_, height_, PNG_COLOR_TYPE_RGB_ALPHA, 8);
}
